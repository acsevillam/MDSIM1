...
foreach(text_file IN LISTS text_files_to_check)
  ...
  if(text_file STREQUAL "src/geometry/detectors/model11/messenger/DetectorModel11Messenger.cc")
    ...
    if(NOT file_content MATCHES "/MultiDetector1/detectors/model11/setImportedGeometryRoot")
      message(FATAL_ERROR "model11 messenger is missing setImportedGeometryRoot")
    endif()
