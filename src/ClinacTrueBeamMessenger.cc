...
#include "ClinacTrueBeamMessenger.hh"
...
ClinacTrueBeamMessenger::ClinacTrueBeamMessenger(ClinacTrueBeam* clinac)
    ...
    fSetJaw1XCmd = new G4UIcmdWithADoubleAndUnit("/MultiDetector1/Clinac/setJaw1X", this);
    ...
    fSetJaw2XCmd = new G4UIcmdWithADoubleAndUnit("/MultiDetector1/Clinac/setJaw2X", this);
    ...
    fSetJaw1YCmd = new G4UIcmdWithADoubleAndUnit("/MultiDetector1/Clinac/setJaw1Y", this);
    ...
    fSetJaw2YCmd = new G4UIcmdWithADoubleAndUnit("/MultiDetector1/Clinac/setJaw2Y", this);
    ...
    fRotateGantryToCmd = new G4UIcmdWithADoubleAndUnit("/MultiDetector1/Clinac/rotateGantryTo", this);
    ...
    fRotateGantryCmd = new G4UIcmdWithADoubleAndUnit("/MultiDetector1/Clinac/rotateGantry", this);
    ...
    fRotateCollimatorToCmd = new G4UIcmdWithADoubleAndUnit("/MultiDetector1/Clinac/rotateCollimatorTo", this);
    ...
    fRotateCollimatorCmd = new G4UIcmdWithADoubleAndUnit("/MultiDetector1/Clinac/rotateCollimator", this);
