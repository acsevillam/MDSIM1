    ...
    if (it != detPhys.end()) {
        ...
        *cRotationJaw1X = cRotationJaw1X->inverse();
        ...
        G4Exception("GenericGeometry::Translate",
                    "TranslateError",
                    FatalException,
                    ("Physical volume with copy number Jaw1X_" + std::to_string(copyNo) + " in geometry " + geometryName + " was not found!").c_str());
    }
    UpdateGeometry();
}
    ...
    if (it != detPhys.end()) {
        ...
        *cRotationJaw2X = cRotationJaw2X->inverse();
        ...
        G4Exception("GenericGeometry::Translate",
                    "TranslateError",
                    FatalException,
                    ("Physical volume with copy number Jaw2X_" + std::to_string(copyNo) + " in geometry " + geometryName + " was not found!").c_str());
    }
    UpdateGeometry();
}
    ...
    if (it != detPhys.end()) {
        ...
        *cRotationJaw1Y = cRotationJaw1Y->inverse();
        ...
        G4Exception("GenericGeometry::Translate",
                    "TranslateError",
                    FatalException,
                    ("Physical volume with copy number Jaw1Y_" + std::to_string(copyNo) + " in geometry " + geometryName + " was not found!").c_str());
    }
    UpdateGeometry();
}
    ...
    if (it != detPhys.end()) {
        ...
        *cRotationJaw2Y = cRotationJaw2Y->inverse();
        ...
        G4Exception("GenericGeometry::Translate",
                    "TranslateError",
                    FatalException,
                    ("Physical volume with copy number Jaw2Y_" + std::to_string(copyNo) + " in geometry " + geometryName + " was not found!").c_str());
    }
    UpdateGeometry();
}
