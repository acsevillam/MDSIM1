...
#include "PhantomWaterBoxMessenger.hh"
...
PhantomWaterBoxMessenger::PhantomWaterBoxMessenger(PhantomWaterBox* phantom)
    ...
    fPhantomIDCmd = new G4UIcmdWithAnInteger("/MultiDetector1/WaterBox/phantomID", this);
    ...
    fTranslateCmd = new G4UIcmdWith3VectorAndUnit("/MultiDetector1/WaterBox/translate", this);
    ...
    fTranslateToCmd = new G4UIcmdWith3VectorAndUnit("/MultiDetector1/WaterBox/translateTo", this);
    ...
    fRotateXCmd = new G4UIcmdWithADoubleAndUnit("/MultiDetector1/WaterBox/rotateX", this);
    ...
    fRotateYCmd = new G4UIcmdWithADoubleAndUnit("/MultiDetector1/WaterBox/rotateY", this);
    ...
    fRotateZCmd = new G4UIcmdWithADoubleAndUnit("/MultiDetector1/WaterBox/rotateZ", this);
    ...
    fRotateToCmd = new G4UIcommand("/MultiDetector1/WaterBox/rotateTo", this);
    ...
    fAddGeometryToCmd = new G4UIcommand("/MultiDetector1/WaterBox/addGeometryTo", this);
    ...
    fRemoveGeometryCmd = new G4UIcmdWithAnInteger("/MultiDetector1/WaterBox/removeGeometry", this);
