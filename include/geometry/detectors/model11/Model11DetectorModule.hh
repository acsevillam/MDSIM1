#ifndef MDSIM1_MODEL11_DETECTOR_MODULE_HH
#define MDSIM1_MODEL11_DETECTOR_MODULE_HH
...
class Model11DetectorModule : public DetectorModule {
public:
    Model11DetectorModule();
    ~Model11DetectorModule() override;

    G4String GetName() const override { return "model11"; }
    G4String GetUiPath() const override { return "/MultiDetector1/detectors/model11/"; }
...
private:
    G4bool fEnabled;
    std::unique_ptr<DetectorModel11> fGeometry;
};

#endif // MDSIM1_MODEL11_DETECTOR_MODULE_HH
