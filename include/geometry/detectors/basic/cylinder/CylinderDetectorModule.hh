...
class CylinderSensitiveDetector;
class CylinderDigitizer;

class CylinderDetectorModule : public DetectorModule {
public:
    CylinderDetectorModule();
    ~CylinderDetectorModule() override;

    G4String GetName() const override { return "cylinder"; }
    G4String GetUiPath() const override { return "/MultiDetector1/detectors/cylinder/"; }
...
private:
    G4bool fEnabled;
    std::unique_ptr<DetectorCylinder> fGeometry;
};
