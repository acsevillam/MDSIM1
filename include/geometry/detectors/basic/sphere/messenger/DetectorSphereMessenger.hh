...
class DetectorSphereMessenger : public G4UImessenger {
public:
    explicit DetectorSphereMessenger(DetectorSphere* detectorSphere);
    ~DetectorSphereMessenger() override;
...
private:
    ...
    DetectorSphere* fDetectorSphere;
    G4int fCurrentDetectorID;

    G4UIcmdWithADoubleAndUnit* fSetSphereRadiusCmd;
    G4UIcmdWithAString* fSetSphereMaterialCmd;
