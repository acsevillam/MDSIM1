/*
   ...
   Advisory:
   1. The authors make no claim of accuracy of the information in these files or the results derived from use of these files.
   2. You are not allowed to re-distribute these files or the information contained within.
   3. The methods and information contained in these files were interpreted by the authors from various sources. It is the user's sole responsibility to verify the accuracy of these files.
   4. If you find an error within these files, we ask that you contact the authors and the distributor of these files.
   5. We ask that you acknowledge the source of these files in publications that use results derived from the input.

   Please contact us if you have any questions.
*/

/* Header File for General Utilities for C++ programs
   File Created:
   ...
   Modification History:
       ...
       03-Dec-1998: JVS: Add #ifndef UTILITIES_H_INCLUDED to ensure single inclusion of the file. All comments "C" compliant
       02-Mar-1999: JVS: Add eprintf_mode
       Dec 3, 1999: JVS: Add check_byte_order
       April 24, 2001: JVS: Add cp
       August 24, 2001: JVS: Change OK from 1 to 0 to make exit(OK) the UNIX standard normal...
...
#ifndef N_DATA
#define N_DATA 4096 /* maximum number of data points */
#endif
#ifdef MAIN
int myerrno = OK;
#else
